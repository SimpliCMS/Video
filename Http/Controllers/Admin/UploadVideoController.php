...
use Modules\Video\Http\Requests\UploadVideo;

class UploadVideoController extends BaseController {

    private const DEFAULT_COLLECTION_NAME = 'videos';
    ...
    public function store(CreateMedia $request) {
        ...
        $model->addMultipleMediaFromRequest(['video'])->each(function ($fileAdder) {
